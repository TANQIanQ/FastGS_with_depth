...
def render_set(model_path, name, iteration, views, gaussians, pipeline, background, args):
    ...
    for idx, view in enumerate(tqdm(views, desc="Rendering progress")):
        ...
        render= render_fastgs(view, gaussians, pipeline, background, args.mult)
...
#         psnr_list.append(psnr(rendering, gt).detach().cpu().mean().double())  
#         ssim_list.append(ssim(rendering, gt).detach().cpu().mean().double())
#         lpips_list.append(lpips(rendering, gt, net_type='vgg').detach().cpu().mean().double())
...
#     print(f"\nEvaluation results for '{name}' set at iteration {iteration}:")
#     print(f'    - Average PSNR: \033[1;35m{avg_psnr.item():.5f}\033[0m')
#     print(f'    - Average SSIM: \033[1;35m{avg_ssim.item():.5f}\033[0m')
#     print(f'    - Average LPIPS: \033[1;35m{avg_lpips.item():.5f}\033[0m')
#     print(f'    - Average FPS: \033[1;35m{fps:.5f}\033[0m')
